...
public class User {
    ...
    public User(UserListRes.UserData userRes) {
        ...
        rating = userRes.getProfileValues().getLinesCode();
    ...
    @Generated(hash = 284055288)
    public User(String remoteId, String photo, @NotNull String fullName,
            @NotNull String searchName, int rating, int codeLines, int projects,
            String bio) {
